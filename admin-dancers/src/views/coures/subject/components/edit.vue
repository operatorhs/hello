<template>
  <el-form ref="editForm" class="search-form" :model="editForm" label-width="200px">
    ...
    <el-form-item label="讲师编号">
      <el-input v-model="editForm.courseLecturerID" size="mini" placeholder="请选择讲师" clearable />
    </el-form-item>
    <el-form-item label="课程类型">
      <el-input v-model="editForm.courseTypeID" size="mini" placeholder="请选择课程类型" clearable />
    </el-form-item>
